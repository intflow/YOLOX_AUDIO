...
class INTFLOWEvaluator:
    """
    INTFLOW AP Evaluation class.  All the data in the val2017 dataset are processed
    and evaluated by COCO API (with data conversion for rbbox support).
    """
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            return cocoEval.stats[0], cocoEval.stats[0], info
        else:
            return 0, 0, info
