...
def make_parser():
    ...
    parser.add_argument("-n", "--name", type=str, default="yolox_nano", help="model name")

    parser.add_argument(
        "--path", default="./assets/numbers2.png", help="path to images or video"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default="exps/yolox__svhn/yolox_nano.py",
        type=str,
        help="pls input your expriment description file",
    )
    parser.add_argument("-c", "--ckpt", default="YOLOX_outputs/yolox__svhn/best_ckpt.pth", type=str, help="ckpt for eval")
